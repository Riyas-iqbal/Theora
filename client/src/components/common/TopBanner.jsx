...
function TopBanner( { promotion='Check out the new thing we launched', LinkTitle = 'Click here', to='about' }) {
  return (
    <>
      <div id="sticky-banner" tabIndex={-1} className="top-0 left-0 z-50 flex justify-between w-full p-4 border-b border-gray-200 bg-gray-200 dark:bg-gray-700 dark:border-gray-600">
        <div className="flex items-center mx-auto">
          <p className="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">
            ...
            <span>
                {promotion} <Link to={to} className="inline font-medium text-blue-600 underline dark:text-blue-500 underline-offset-2 decoration-600 dark:decoration-500 decoration-solid hover:no-underline">
                {LinkTitle }
                </Link>
            </span>
          </p>
